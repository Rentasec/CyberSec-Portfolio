...
*Research prompt:* Phishing is the initial access vector in over 90% of healthcare cyberattacks. As someone with healthcare experience, think about the daily environment of a clinical or administrative worker — the volume of emails, the pressure, the unfamiliarity with security practices. Write a short paragraph (from your own professional experience and perspective) explaining *why* healthcare workers are a particularly effective target for phishing. Then add one sentence on what a realistic phishing email targeting a hospital administrator might look like.  
*This gap is intentionally experiential — your answer will be more credible than anything you can copy from a search result.*
